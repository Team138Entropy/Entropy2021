...
public class OurWPITalonSRX implements IMotorController, SpeedController, Sendable {
  ...
  public void set (ControlMode mode, double value) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": set(" + String.valueOf(mode) + ", " + String.valueOf(value) + ")");
    }
  }
  ...
  public void set (ControlMode mode, double demand0, double demand1) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": set(" + String.valueOf(mode) + ", " + String.valueOf(demand0) + ", " + String.valueOf(demand1) + ")");
    }
  }
  ...
  public void set (ControlMode mode, double demand0, DemandType demand1Type, double demand1) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": set(" + String.valueOf(mode) + ", " + String.valueOf(demand0) + ", " + String.valueOf(demand1Type) + ", " + String.valueOf(demand1) + ")");
    }
  }
  ...
  public final void setName (String moduleType, int channel) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": setName(" + String.valueOf(moduleType) + ", " + String.valueOf(channel) + ")");
    }
  }
  ...
  public final void setName (String moduleType, int moduleNumber, int channel) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": setName(" + String.valueOf(moduleType) + ", " + String.valueOf(moduleNumber) + ", " + String.valueOf(channel) + ")");
    }
  }
  ...
  public ErrorCode configSelectedFeedbackSensor (TalonSRXFeedbackDevice feedbackDevice, int pidIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configSelectedFeedbackSensor(" + String.valueOf(feedbackDevice) + ", " + String.valueOf(pidIdx) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configSupplyCurrentLimit (SupplyCurrentLimitConfiguration currLimitConfigs, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configSupplyCurrentLimit(" + String.valueOf(currLimitConfigs) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configSupplyCurrentLimit (SupplyCurrentLimitConfiguration currLimitConfigs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configSupplyCurrentLimit(" + String.valueOf(currLimitConfigs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configPeakCurrentLimit (int amps, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configPeakCurrentLimit(" + String.valueOf(amps) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configPeakCurrentDuration (int milliseconds, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configPeakCurrentDuration(" + String.valueOf(milliseconds) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configPeakCurrentDuration (int milliseconds) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configPeakCurrentDuration(" + String.valueOf(milliseconds) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configContinuousCurrentLimit (int amps, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configContinuousCurrentLimit(" + String.valueOf(amps) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configContinuousCurrentLimit (int amps) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configContinuousCurrentLimit(" + String.valueOf(amps) + ")");
      return null;
    }
  }
  ...
  public void getPIDConfigs (TalonSRXPIDSetConfiguration pid, int pidIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": getPIDConfigs(" + String.valueOf(pid) + ", " + String.valueOf(pidIdx) + ", " + String.valueOf(timeoutMs) + ")");
    }
  }
  ...
  public ErrorCode configAllSettings (TalonSRXConfiguration allConfigs, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configAllSettings(" + String.valueOf(allConfigs) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public void getAllConfigs (TalonSRXConfiguration allConfigs, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": getAllConfigs(" + String.valueOf(allConfigs) + ", " + String.valueOf(timeoutMs) + ")");
    }
  }
  ...
  public ErrorCode setStatusFramePeriod (StatusFrameEnhanced frame, int periodMs, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": setStatusFramePeriod(" + String.valueOf(frame) + ", " + String.valueOf(periodMs) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode setStatusFramePeriod (StatusFrameEnhanced frame, int periodMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": setStatusFramePeriod(" + String.valueOf(frame) + ", " + String.valueOf(periodMs) + ")");
      return null;
    }
  }
  ...
  public int getStatusFramePeriod (StatusFrameEnhanced frame, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": getStatusFramePeriod(" + String.valueOf(frame) + ", " + String.valueOf(timeoutMs) + ")");
      return 0;
    }
  }
  ...
  public ErrorCode configVelocityMeasurementPeriod (VelocityMeasPeriod period, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configVelocityMeasurementPeriod(" + String.valueOf(period) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configVelocityMeasurementPeriod (VelocityMeasPeriod period) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configVelocityMeasurementPeriod(" + String.valueOf(period) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configVelocityMeasurementWindow (int windowSize, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configVelocityMeasurementWindow(" + String.valueOf(windowSize) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configVelocityMeasurementWindow (int windowSize) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configVelocityMeasurementWindow(" + String.valueOf(windowSize) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configForwardLimitSwitchSource (LimitSwitchSource type, LimitSwitchNormal normalOpenOrClose, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configForwardLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configForwardLimitSwitchSource (LimitSwitchSource type, LimitSwitchNormal normalOpenOrClose) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configForwardLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configReverseLimitSwitchSource (LimitSwitchSource type, LimitSwitchNormal normalOpenOrClose, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configReverseLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configReverseLimitSwitchSource (LimitSwitchSource type, LimitSwitchNormal normalOpenOrClose) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configReverseLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configOpenloopRamp (double secondsFromNeutralToFull, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configOpenloopRamp(" + String.valueOf(secondsFromNeutralToFull) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configOpenloopRamp (double secondsFromNeutralToFull) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configOpenloopRamp(" + String.valueOf(secondsFromNeutralToFull) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configClosedloopRamp (double secondsFromNeutralToFull, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configClosedloopRamp(" + String.valueOf(secondsFromNeutralToFull) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configClosedloopRamp (double secondsFromNeutralToFull) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configClosedloopRamp(" + String.valueOf(secondsFromNeutralToFull) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configPeakOutputForward (double percentOut, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configPeakOutputForward(" + String.valueOf(percentOut) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configPeakOutputForward (double percentOut) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configPeakOutputForward(" + String.valueOf(percentOut) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configPeakOutputReverse (double percentOut, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configPeakOutputReverse(" + String.valueOf(percentOut) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configPeakOutputReverse (double percentOut) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configPeakOutputReverse(" + String.valueOf(percentOut) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configNominalOutputForward (double percentOut, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configNominalOutputForward(" + String.valueOf(percentOut) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configNominalOutputForward (double percentOut) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configNominalOutputForward(" + String.valueOf(percentOut) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configNominalOutputReverse (double percentOut, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configNominalOutputReverse(" + String.valueOf(percentOut) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configNominalOutputReverse (double percentOut) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configNominalOutputReverse(" + String.valueOf(percentOut) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configNeutralDeadband (double percentDeadband, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configNeutralDeadband(" + String.valueOf(percentDeadband) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configNeutralDeadband (double percentDeadband) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configNeutralDeadband(" + String.valueOf(percentDeadband) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configVoltageCompSaturation (double voltage, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configVoltageCompSaturation(" + String.valueOf(voltage) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configVoltageCompSaturation (double voltage) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configVoltageCompSaturation(" + String.valueOf(voltage) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configVoltageMeasurementFilter (int filterWindowSamples, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configVoltageMeasurementFilter(" + String.valueOf(filterWindowSamples) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configVoltageMeasurementFilter (int filterWindowSamples) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configVoltageMeasurementFilter(" + String.valueOf(filterWindowSamples) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configSelectedFeedbackSensor (RemoteFeedbackDevice feedbackDevice) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configSelectedFeedbackSensor(" + String.valueOf(feedbackDevice) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configSelectedFeedbackCoefficient (double coefficient, int pidIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configSelectedFeedbackCoefficient(" + String.valueOf(coefficient) + ", " + String.valueOf(pidIdx) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configSelectedFeedbackCoefficient (double coefficient) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configSelectedFeedbackCoefficient(" + String.valueOf(coefficient) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configRemoteFeedbackFilter (int deviceID, RemoteSensorSource remoteSensorSource, int remoteOrdinal, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configRemoteFeedbackFilter(" + String.valueOf(deviceID) + ", " + String.valueOf(remoteSensorSource) + ", " + String.valueOf(remoteOrdinal) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configRemoteFeedbackFilter (int deviceID, RemoteSensorSource remoteSensorSource, int remoteOrdinal) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configRemoteFeedbackFilter(" + String.valueOf(deviceID) + ", " + String.valueOf(remoteSensorSource) + ", " + String.valueOf(remoteOrdinal) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configRemoteFeedbackFilter (CANCoder canCoderRef, int remoteOrdinal, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configRemoteFeedbackFilter(" + String.valueOf(canCoderRef) + ", " + String.valueOf(remoteOrdinal) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configRemoteFeedbackFilter (CANCoder canCoderRef, int remoteOrdinal) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configRemoteFeedbackFilter(" + String.valueOf(canCoderRef) + ", " + String.valueOf(remoteOrdinal) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configSensorTerm (SensorTerm sensorTerm, FeedbackDevice feedbackDevice, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configSensorTerm(" + String.valueOf(sensorTerm) + ", " + String.valueOf(feedbackDevice) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configSensorTerm (SensorTerm sensorTerm, FeedbackDevice feedbackDevice) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configSensorTerm(" + String.valueOf(sensorTerm) + ", " + String.valueOf(feedbackDevice) + ")");
      return null;
    }
  }
  ...
  public ErrorCode setSelectedSensorPosition (int sensorPos, int pidIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": setSelectedSensorPosition(" + String.valueOf(sensorPos) + ", " + String.valueOf(pidIdx) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode setSelectedSensorPosition (int sensorPos) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": setSelectedSensorPosition(" + String.valueOf(sensorPos) + ")");
      return null;
    }
  }
  ...
  public ErrorCode setControlFramePeriod (ControlFrame frame, int periodMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": setControlFramePeriod(" + String.valueOf(frame) + ", " + String.valueOf(periodMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode setStatusFramePeriod (int frameValue, int periodMs, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": setStatusFramePeriod(" + String.valueOf(frameValue) + ", " + String.valueOf(periodMs) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode setStatusFramePeriod (int frameValue, int periodMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": setStatusFramePeriod(" + String.valueOf(frameValue) + ", " + String.valueOf(periodMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configForwardLimitSwitchSource (RemoteLimitSwitchSource type, LimitSwitchNormal normalOpenOrClose, int deviceID, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configForwardLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ", " + String.valueOf(deviceID) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configForwardLimitSwitchSource (RemoteLimitSwitchSource type, LimitSwitchNormal normalOpenOrClose, int deviceID) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configForwardLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ", " + String.valueOf(deviceID) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configReverseLimitSwitchSource (RemoteLimitSwitchSource type, LimitSwitchNormal normalOpenOrClose, int deviceID, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configReverseLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ", " + String.valueOf(deviceID) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configReverseLimitSwitchSource (RemoteLimitSwitchSource type, LimitSwitchNormal normalOpenOrClose, int deviceID) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configReverseLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ", " + String.valueOf(deviceID) + ")");
      return null;
    }
  }
  ...
  public void overrideLimitSwitchesEnable (boolean enable) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": overrideLimitSwitchesEnable(" + String.valueOf(enable) + ")");
    }
  }
  ...
  public ErrorCode configForwardSoftLimitThreshold (int forwardSensorLimit, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configForwardSoftLimitThreshold(" + String.valueOf(forwardSensorLimit) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configForwardSoftLimitThreshold (int forwardSensorLimit) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configForwardSoftLimitThreshold(" + String.valueOf(forwardSensorLimit) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configReverseSoftLimitThreshold (int reverseSensorLimit, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configReverseSoftLimitThreshold(" + String.valueOf(reverseSensorLimit) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configReverseSoftLimitThreshold (int reverseSensorLimit) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configReverseSoftLimitThreshold(" + String.valueOf(reverseSensorLimit) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configForwardSoftLimitEnable (boolean enable, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configForwardSoftLimitEnable(" + String.valueOf(enable) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configForwardSoftLimitEnable (boolean enable) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configForwardSoftLimitEnable(" + String.valueOf(enable) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configReverseSoftLimitEnable (boolean enable, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configReverseSoftLimitEnable(" + String.valueOf(enable) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configReverseSoftLimitEnable (boolean enable) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configReverseSoftLimitEnable(" + String.valueOf(enable) + ")");
      return null;
    }
  }
  ...
  public ErrorCode config_kP (int slotIdx, double value, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": config_kP(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode config_kP (int slotIdx, double value) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": config_kP(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ")");
      return null;
    }
  }
  ...
  public ErrorCode config_kI (int slotIdx, double value, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": config_kI(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode config_kI (int slotIdx, double value) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": config_kI(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ")");
      return null;
    }
  }
  ...
  public ErrorCode config_kD (int slotIdx, double value, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": config_kD(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode config_kD (int slotIdx, double value) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": config_kD(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ")");
      return null;
    }
  }
  ...
  public ErrorCode config_kF (int slotIdx, double value, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": config_kF(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode config_kF (int slotIdx, double value) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": config_kF(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ")");
      return null;
    }
  }
  ...
  public ErrorCode config_IntegralZone (int slotIdx, int izone, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": config_IntegralZone(" + String.valueOf(slotIdx) + ", " + String.valueOf(izone) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode config_IntegralZone (int slotIdx, int izone) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": config_IntegralZone(" + String.valueOf(slotIdx) + ", " + String.valueOf(izone) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configAllowableClosedloopError (int slotIdx, int allowableClosedLoopError, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configAllowableClosedloopError(" + String.valueOf(slotIdx) + ", " + String.valueOf(allowableClosedLoopError) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configAllowableClosedloopError (int slotIdx, int allowableClosedLoopError) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configAllowableClosedloopError(" + String.valueOf(slotIdx) + ", " + String.valueOf(allowableClosedLoopError) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configMaxIntegralAccumulator (int slotIdx, double iaccum, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configMaxIntegralAccumulator(" + String.valueOf(slotIdx) + ", " + String.valueOf(iaccum) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configMaxIntegralAccumulator (int slotIdx, double iaccum) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configMaxIntegralAccumulator(" + String.valueOf(slotIdx) + ", " + String.valueOf(iaccum) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configClosedLoopPeakOutput (int slotIdx, double percentOut, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configClosedLoopPeakOutput(" + String.valueOf(slotIdx) + ", " + String.valueOf(percentOut) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configClosedLoopPeakOutput (int slotIdx, double percentOut) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configClosedLoopPeakOutput(" + String.valueOf(slotIdx) + ", " + String.valueOf(percentOut) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configClosedLoopPeriod (int slotIdx, int loopTimeMs, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configClosedLoopPeriod(" + String.valueOf(slotIdx) + ", " + String.valueOf(loopTimeMs) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configClosedLoopPeriod (int slotIdx, int loopTimeMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configClosedLoopPeriod(" + String.valueOf(slotIdx) + ", " + String.valueOf(loopTimeMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configAuxPIDPolarity (boolean invert, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configAuxPIDPolarity(" + String.valueOf(invert) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode setIntegralAccumulator (double iaccum, int pidIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": setIntegralAccumulator(" + String.valueOf(iaccum) + ", " + String.valueOf(pidIdx) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public void selectProfileSlot (int slotIdx, int pidIdx) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": selectProfileSlot(" + String.valueOf(slotIdx) + ", " + String.valueOf(pidIdx) + ")");
    }
  }
  ...
  public int getActiveTrajectoryPosition (int pidIdx) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": getActiveTrajectoryPosition(" + String.valueOf(pidIdx) + ")");
      return 0;
    }
  }
  ...
  public int getActiveTrajectoryVelocity (int pidIdx) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": getActiveTrajectoryVelocity(" + String.valueOf(pidIdx) + ")");
      return 0;
    }
  }
  ...
  public double getActiveTrajectoryArbFeedFwd (int pidIdx) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": getActiveTrajectoryArbFeedFwd(" + String.valueOf(pidIdx) + ")");
      return 0;
    }
  }
  ...
  public ErrorCode configMotionCruiseVelocity (int sensorUnitsPer100ms, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configMotionCruiseVelocity(" + String.valueOf(sensorUnitsPer100ms) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configMotionCruiseVelocity (int sensorUnitsPer100ms) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configMotionCruiseVelocity(" + String.valueOf(sensorUnitsPer100ms) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configMotionAcceleration (int sensorUnitsPer100msPerSec, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configMotionAcceleration(" + String.valueOf(sensorUnitsPer100msPerSec) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configMotionAcceleration (int sensorUnitsPer100msPerSec) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configMotionAcceleration(" + String.valueOf(sensorUnitsPer100msPerSec) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configMotionSCurveStrength (int curveStrength, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configMotionSCurveStrength(" + String.valueOf(curveStrength) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configMotionSCurveStrength (int curveStrength) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configMotionSCurveStrength(" + String.valueOf(curveStrength) + ")");
      return null;
    }
  }
  ...
  public ErrorCode pushMotionProfileTrajectory (TrajectoryPoint trajPt) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": pushMotionProfileTrajectory(" + String.valueOf(trajPt) + ")");
      return null;
    }
  }
  ...
  public ErrorCode startMotionProfile (BufferedTrajectoryPointStream stream, int minBufferedPts, ControlMode motionProfControlMode) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": startMotionProfile(" + String.valueOf(stream) + ", " + String.valueOf(minBufferedPts) + ", " + String.valueOf(motionProfControlMode) + ")");
      return null;
    }
  }
  ...
  public ErrorCode getMotionProfileStatus (MotionProfileStatus statusToFill) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": getMotionProfileStatus(" + String.valueOf(statusToFill) + ")");
      return null;
    }
  }
  ...
  public ErrorCode clearMotionProfileHasUnderrun (int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": clearMotionProfileHasUnderrun(" + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode changeMotionControlFramePeriod (int periodMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": changeMotionControlFramePeriod(" + String.valueOf(periodMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configMotionProfileTrajectoryPeriod (int baseTrajDurationMs, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configMotionProfileTrajectoryPeriod(" + String.valueOf(baseTrajDurationMs) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configMotionProfileTrajectoryPeriod (int baseTrajDurationMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configMotionProfileTrajectoryPeriod(" + String.valueOf(baseTrajDurationMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configMotionProfileTrajectoryInterpolationEnable (boolean enable, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configMotionProfileTrajectoryInterpolationEnable(" + String.valueOf(enable) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configMotionProfileTrajectoryInterpolationEnable (boolean enable) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configMotionProfileTrajectoryInterpolationEnable(" + String.valueOf(enable) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configFeedbackNotContinuous (boolean feedbackNotContinuous, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configFeedbackNotContinuous(" + String.valueOf(feedbackNotContinuous) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configRemoteSensorClosedLoopDisableNeutralOnLOS (boolean remoteSensorClosedLoopDisableNeutralOnLOS, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configRemoteSensorClosedLoopDisableNeutralOnLOS(" + String.valueOf(remoteSensorClosedLoopDisableNeutralOnLOS) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configClearPositionOnLimitF (boolean clearPositionOnLimitF, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configClearPositionOnLimitF(" + String.valueOf(clearPositionOnLimitF) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configClearPositionOnLimitR (boolean clearPositionOnLimitR, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configClearPositionOnLimitR(" + String.valueOf(clearPositionOnLimitR) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configClearPositionOnQuadIdx (boolean clearPositionOnQuadIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configClearPositionOnQuadIdx(" + String.valueOf(clearPositionOnQuadIdx) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configLimitSwitchDisableNeutralOnLOS (boolean limitSwitchDisableNeutralOnLOS, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configLimitSwitchDisableNeutralOnLOS(" + String.valueOf(limitSwitchDisableNeutralOnLOS) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configSoftLimitDisableNeutralOnLOS (boolean softLimitDisableNeutralOnLOS, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configSoftLimitDisableNeutralOnLOS(" + String.valueOf(softLimitDisableNeutralOnLOS) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configPulseWidthPeriod_EdgesPerRot (int pulseWidthPeriod_EdgesPerRot, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configPulseWidthPeriod_EdgesPerRot(" + String.valueOf(pulseWidthPeriod_EdgesPerRot) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configPulseWidthPeriod_FilterWindowSz (int pulseWidthPeriod_FilterWindowSz, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configPulseWidthPeriod_FilterWindowSz(" + String.valueOf(pulseWidthPeriod_FilterWindowSz) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configSetCustomParam (int newValue, int paramIndex, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configSetCustomParam(" + String.valueOf(newValue) + ", " + String.valueOf(paramIndex) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configSetCustomParam (int newValue, int paramIndex) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configSetCustomParam(" + String.valueOf(newValue) + ", " + String.valueOf(paramIndex) + ")");
      return null;
    }
  }
  ...
  public int configGetCustomParam (int paramIndex, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configGetCustomParam(" + String.valueOf(paramIndex) + ", " + String.valueOf(timeoutMs) + ")");
      return 0;
    }
  }
  ...
  public ErrorCode configSetParameter (ParamEnum param, double value, int subValue, int ordinal, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configSetParameter(" + String.valueOf(param) + ", " + String.valueOf(value) + ", " + String.valueOf(subValue) + ", " + String.valueOf(ordinal) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configSetParameter (ParamEnum param, double value, int subValue, int ordinal) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configSetParameter(" + String.valueOf(param) + ", " + String.valueOf(value) + ", " + String.valueOf(subValue) + ", " + String.valueOf(ordinal) + ")");
      return null;
    }
  }
  ...
  public double configGetParameter (ParamEnum param, int ordinal, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configGetParameter(" + String.valueOf(param) + ", " + String.valueOf(ordinal) + ", " + String.valueOf(timeoutMs) + ")");
      return 0;
    }
  }
  ...
  public double configGetParameter (ParamEnum param, int ordinal) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configGetParameter(" + String.valueOf(param) + ", " + String.valueOf(ordinal) + ")");
      return 0;
    }
  }
  ...
  public void follow (IMotorController masterToFollow, FollowerType followerType) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": follow(" + String.valueOf(masterToFollow) + ", " + String.valueOf(followerType) + ")");
    }
  }
  ...
  public ErrorCode configureSlot (SlotConfiguration slot, int slotIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configureSlot(" + String.valueOf(slot) + ", " + String.valueOf(slotIdx) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public void getSlotConfigs (SlotConfiguration slot, int slotIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": getSlotConfigs(" + String.valueOf(slot) + ", " + String.valueOf(slotIdx) + ", " + String.valueOf(timeoutMs) + ")");
    }
  }
  ...
  public ErrorCode configureFilter (FilterConfiguration filter, int ordinal, int timeoutMs, boolean enableOptimizations) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configureFilter(" + String.valueOf(filter) + ", " + String.valueOf(ordinal) + ", " + String.valueOf(timeoutMs) + ", " + String.valueOf(enableOptimizations) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configureFilter (FilterConfiguration filter, int ordinal, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": configureFilter(" + String.valueOf(filter) + ", " + String.valueOf(ordinal) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public void getFilterConfigs (FilterConfiguration filter, int ordinal, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose(deviceNumber + ": getFilterConfigs(" + String.valueOf(filter) + ", " + String.valueOf(ordinal) + ", " + String.valueOf(timeoutMs) + ")");
    }
  }
