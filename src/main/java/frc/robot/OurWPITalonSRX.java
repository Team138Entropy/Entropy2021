...
/**
 * This class provides a wrapper around WPITalonSRX that works in the robot simulator
 * All method calls are logged (see Loggers.SIMULATEDTALON in Constants.java)
 * All methods with a primitive return type return 0 or false, and all object return types return null
 * You should check for these, or check Robot.isReal() to determine if the code is being run in the simulator
 */
public class OurWPITalonSRX {
  ...
  public void set (double speed) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("set(" + String.valueOf(speed) + ")");
    }
  }
  public void pidWrite (double output) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("pidWrite(" + String.valueOf(output) + ")");
    }
  }
  public double get () {
    if(Robot.isReal()){
  ...
  public void set (ControlMode mode, double value) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("set(" + String.valueOf(mode) + ", " + String.valueOf(value) + ")");
    }
  }
  public void set (ControlMode mode, double demand0, double demand1) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("set(" + String.valueOf(mode) + ", " + String.valueOf(demand0) + ", " + String.valueOf(demand1) + ")");
    }
  }
  public void set (ControlMode mode, double demand0, DemandType demand1Type, double demand1) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("set(" + String.valueOf(mode) + ", " + String.valueOf(demand0) + ", " + String.valueOf(demand1Type) + ", " + String.valueOf(demand1) + ")");
    }
  }
  public void setVoltage (double outputVolts) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setVoltage(" + String.valueOf(outputVolts) + ")");
    }
  }
  public void setInverted (boolean isInverted) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setInverted(" + String.valueOf(isInverted) + ")");
    }
  }
  ...
  public final synchronized void setName (String name) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setName(" + String.valueOf(name) + ")");
    }
  }
  public final void setName (String moduleType, int channel) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setName(" + String.valueOf(moduleType) + ", " + String.valueOf(channel) + ")");
    }
  }
  public final void setName (String moduleType, int moduleNumber, int channel) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setName(" + String.valueOf(moduleType) + ", " + String.valueOf(moduleNumber) + ", " + String.valueOf(channel) + ")");
    }
  }
  ...
  public final synchronized void setSubsystem (String subsystem) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setSubsystem(" + String.valueOf(subsystem) + ")");
    }
  }
  public final void addChild (Object child) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("addChild(" + String.valueOf(child) + ")");
    }
  }
  public void initSendable (SendableBuilder builder) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("initSendable(" + String.valueOf(builder) + ")");
    }
  }
  public String getDescription () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getDescription()");
      return null;
    }
  }
  public void feed () {
  ...
  public void setExpiration (double expirationTime) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setExpiration(" + String.valueOf(expirationTime) + ")");
    }
  }
  ...
  public void setSafetyEnabled (boolean enabled) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setSafetyEnabled(" + String.valueOf(enabled) + ")");
    }
  }
  public boolean isSafetyEnabled () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("isSafetyEnabled()");
      return false;
    }
  }
  public SensorCollection getSensorCollection () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getSensorCollection()");
      return null;
    }
  }
  public ErrorCode configSelectedFeedbackSensor (TalonSRXFeedbackDevice feedbackDevice, int pidIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configSelectedFeedbackSensor(" + String.valueOf(feedbackDevice) + ", " + String.valueOf(pidIdx) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configSupplyCurrentLimit (SupplyCurrentLimitConfiguration currLimitConfigs, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configSupplyCurrentLimit(" + String.valueOf(currLimitConfigs) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configSupplyCurrentLimit (SupplyCurrentLimitConfiguration currLimitConfigs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configSupplyCurrentLimit(" + String.valueOf(currLimitConfigs) + ")");
      return null;
    }
  }
  public ErrorCode configPeakCurrentLimit (int amps, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configPeakCurrentLimit(" + String.valueOf(amps) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configPeakCurrentLimit (int amps) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configPeakCurrentLimit(" + String.valueOf(amps) + ")");
      return null;
    }
  }
  public ErrorCode configPeakCurrentDuration (int milliseconds, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configPeakCurrentDuration(" + String.valueOf(milliseconds) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configPeakCurrentDuration (int milliseconds) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configPeakCurrentDuration(" + String.valueOf(milliseconds) + ")");
      return null;
    }
  }
  public ErrorCode configContinuousCurrentLimit (int amps, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configContinuousCurrentLimit(" + String.valueOf(amps) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configContinuousCurrentLimit (int amps) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configContinuousCurrentLimit(" + String.valueOf(amps) + ")");
      return null;
    }
  }
  public void enableCurrentLimit (boolean enable) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("enableCurrentLimit(" + String.valueOf(enable) + ")");
    }
  }
  public void getPIDConfigs (TalonSRXPIDSetConfiguration pid, int pidIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getPIDConfigs(" + String.valueOf(pid) + ", " + String.valueOf(pidIdx) + ", " + String.valueOf(timeoutMs) + ")");
    }
  }
  public void getPIDConfigs (TalonSRXPIDSetConfiguration pid) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getPIDConfigs(" + String.valueOf(pid) + ")");
    }
  }
  public ErrorCode configAllSettings (TalonSRXConfiguration allConfigs, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configAllSettings(" + String.valueOf(allConfigs) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configAllSettings (TalonSRXConfiguration allConfigs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configAllSettings(" + String.valueOf(allConfigs) + ")");
      return null;
    }
  }
  public void getAllConfigs (TalonSRXConfiguration allConfigs, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getAllConfigs(" + String.valueOf(allConfigs) + ", " + String.valueOf(timeoutMs) + ")");
    }
  }
  public void getAllConfigs (TalonSRXConfiguration allConfigs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getAllConfigs(" + String.valueOf(allConfigs) + ")");
    }
  }
  public ErrorCode setStatusFramePeriod (StatusFrameEnhanced frame, int periodMs, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setStatusFramePeriod(" + String.valueOf(frame) + ", " + String.valueOf(periodMs) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode setStatusFramePeriod (StatusFrameEnhanced frame, int periodMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setStatusFramePeriod(" + String.valueOf(frame) + ", " + String.valueOf(periodMs) + ")");
      return null;
    }
  }
  public int getStatusFramePeriod (StatusFrameEnhanced frame, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getStatusFramePeriod(" + String.valueOf(frame) + ", " + String.valueOf(timeoutMs) + ")");
      return 0;
    }
  }
  public int getStatusFramePeriod (StatusFrameEnhanced frame) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getStatusFramePeriod(" + String.valueOf(frame) + ")");
      return 0;
    }
  }
  public double getOutputCurrent () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getOutputCurrent()");
      return 0;
    }
  }
  public double getStatorCurrent () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getStatorCurrent()");
      return 0;
    }
  }
  public double getSupplyCurrent () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getSupplyCurrent()");
      return 0;
    }
  }
  public ErrorCode configVelocityMeasurementPeriod (VelocityMeasPeriod period, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configVelocityMeasurementPeriod(" + String.valueOf(period) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configVelocityMeasurementPeriod (VelocityMeasPeriod period) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configVelocityMeasurementPeriod(" + String.valueOf(period) + ")");
      return null;
    }
  }
  public ErrorCode configVelocityMeasurementWindow (int windowSize, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configVelocityMeasurementWindow(" + String.valueOf(windowSize) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configVelocityMeasurementWindow (int windowSize) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configVelocityMeasurementWindow(" + String.valueOf(windowSize) + ")");
      return null;
    }
  }
  public ErrorCode configForwardLimitSwitchSource (LimitSwitchSource type, LimitSwitchNormal normalOpenOrClose, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configForwardLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configForwardLimitSwitchSource (LimitSwitchSource type, LimitSwitchNormal normalOpenOrClose) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configForwardLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ")");
      return null;
    }
  }
  public ErrorCode configReverseLimitSwitchSource (LimitSwitchSource type, LimitSwitchNormal normalOpenOrClose, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configReverseLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configReverseLimitSwitchSource (LimitSwitchSource type, LimitSwitchNormal normalOpenOrClose) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configReverseLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ")");
      return null;
    }
  }
  public int isFwdLimitSwitchClosed () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("isFwdLimitSwitchClosed()");
      return 0;
    }
  }
  public int isRevLimitSwitchClosed () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("isRevLimitSwitchClosed()");
      return 0;
    }
  }
  ...
  public void setNeutralMode (NeutralMode neutralMode) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setNeutralMode(" + String.valueOf(neutralMode) + ")");
    }
  }
  public void enableHeadingHold (boolean enable) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("enableHeadingHold(" + String.valueOf(enable) + ")");
    }
  }
  public void selectDemandType (boolean value) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("selectDemandType(" + String.valueOf(value) + ")");
    }
  }
  public void setSensorPhase (boolean PhaseSensor) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setSensorPhase(" + String.valueOf(PhaseSensor) + ")");
    }
  }
  public void setInverted (InvertType invertType) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setInverted(" + String.valueOf(invertType) + ")");
    }
  }
  public ErrorCode configFactoryDefault (int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configFactoryDefault(" + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configFactoryDefault () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configFactoryDefault()");
      return null;
    }
  }
  public ErrorCode configOpenloopRamp (double secondsFromNeutralToFull, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configOpenloopRamp(" + String.valueOf(secondsFromNeutralToFull) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configOpenloopRamp (double secondsFromNeutralToFull) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configOpenloopRamp(" + String.valueOf(secondsFromNeutralToFull) + ")");
      return null;
    }
  }
  public ErrorCode configClosedloopRamp (double secondsFromNeutralToFull, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configClosedloopRamp(" + String.valueOf(secondsFromNeutralToFull) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configClosedloopRamp (double secondsFromNeutralToFull) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configClosedloopRamp(" + String.valueOf(secondsFromNeutralToFull) + ")");
      return null;
    }
  }
  public ErrorCode configPeakOutputForward (double percentOut, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configPeakOutputForward(" + String.valueOf(percentOut) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configPeakOutputForward (double percentOut) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configPeakOutputForward(" + String.valueOf(percentOut) + ")");
      return null;
    }
  }
  public ErrorCode configPeakOutputReverse (double percentOut, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configPeakOutputReverse(" + String.valueOf(percentOut) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configPeakOutputReverse (double percentOut) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configPeakOutputReverse(" + String.valueOf(percentOut) + ")");
      return null;
    }
  }
  public ErrorCode configNominalOutputForward (double percentOut, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configNominalOutputForward(" + String.valueOf(percentOut) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configNominalOutputForward (double percentOut) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configNominalOutputForward(" + String.valueOf(percentOut) + ")");
      return null;
    }
  }
  public ErrorCode configNominalOutputReverse (double percentOut, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configNominalOutputReverse(" + String.valueOf(percentOut) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configNominalOutputReverse (double percentOut) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configNominalOutputReverse(" + String.valueOf(percentOut) + ")");
      return null;
    }
  }
  public ErrorCode configNeutralDeadband (double percentDeadband, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configNeutralDeadband(" + String.valueOf(percentDeadband) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configNeutralDeadband (double percentDeadband) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configNeutralDeadband(" + String.valueOf(percentDeadband) + ")");
      return null;
    }
  }
  public ErrorCode configVoltageCompSaturation (double voltage, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configVoltageCompSaturation(" + String.valueOf(voltage) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configVoltageCompSaturation (double voltage) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configVoltageCompSaturation(" + String.valueOf(voltage) + ")");
      return null;
    }
  }
  public ErrorCode configVoltageMeasurementFilter (int filterWindowSamples, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configVoltageMeasurementFilter(" + String.valueOf(filterWindowSamples) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configVoltageMeasurementFilter (int filterWindowSamples) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configVoltageMeasurementFilter(" + String.valueOf(filterWindowSamples) + ")");
      return null;
    }
  }
  public void enableVoltageCompensation (boolean enable) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("enableVoltageCompensation(" + String.valueOf(enable) + ")");
    }
  }
  ...
  public double getMotorOutputPercent () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getMotorOutputPercent()");
      return 0;
    }
  }
  public double getMotorOutputVoltage () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getMotorOutputVoltage()");
      return 0;
    }
  }
  public double getTemperature () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getTemperature()");
      return 0;
    }
  }
  ...
  public ErrorCode configSelectedFeedbackSensor (RemoteFeedbackDevice feedbackDevice) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configSelectedFeedbackSensor(" + String.valueOf(feedbackDevice) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configSelectedFeedbackCoefficient (double coefficient, int pidIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configSelectedFeedbackCoefficient(" + String.valueOf(coefficient) + ", " + String.valueOf(pidIdx) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configSelectedFeedbackCoefficient (double coefficient) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configSelectedFeedbackCoefficient(" + String.valueOf(coefficient) + ")");
      return null;
    }
  }
  public ErrorCode configRemoteFeedbackFilter (int deviceID, RemoteSensorSource remoteSensorSource, int remoteOrdinal, int timeoutMs) {
    if(Robot.isReal()){
      return thisTalon.configRemoteFeedbackFilter(deviceID, remoteSensorSource, remoteOrdinal, timeoutMs);
    }else{
      mLogger.verbose("configRemoteFeedbackFilter(" + String.valueOf(deviceID) + ", " + String.valueOf(remoteSensorSource) + ", " + String.valueOf(remoteOrdinal) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configRemoteFeedbackFilter (int deviceID, RemoteSensorSource remoteSensorSource, int remoteOrdinal) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configRemoteFeedbackFilter(" + String.valueOf(deviceID) + ", " + String.valueOf(remoteSensorSource) + ", " + String.valueOf(remoteOrdinal) + ")");
      return null;
    }
  }
  public ErrorCode configSensorTerm (SensorTerm sensorTerm, FeedbackDevice feedbackDevice, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configSensorTerm(" + String.valueOf(sensorTerm) + ", " + String.valueOf(feedbackDevice) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configSensorTerm (SensorTerm sensorTerm, FeedbackDevice feedbackDevice) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configSensorTerm(" + String.valueOf(sensorTerm) + ", " + String.valueOf(feedbackDevice) + ")");
      return null;
    }
  }
  ...
  public int getSelectedSensorPosition (int pidIdx) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getSelectedSensorPosition(" + String.valueOf(pidIdx) + ")");
      return 0;
    }
  }
  public int getSelectedSensorPosition () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getSelectedSensorPosition()");
      return 0;
    }
  }
  public int getSelectedSensorVelocity (int pidIdx) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getSelectedSensorVelocity(" + String.valueOf(pidIdx) + ")");
      return 0;
    }
  }
  public int getSelectedSensorVelocity () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getSelectedSensorVelocity()");
      return 0;
    }
  }
  public ErrorCode setSelectedSensorPosition (int sensorPos, int pidIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setSelectedSensorPosition(" + String.valueOf(sensorPos) + ", " + String.valueOf(pidIdx) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode setSelectedSensorPosition (int sensorPos) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setSelectedSensorPosition(" + String.valueOf(sensorPos) + ")");
      return null;
    }
  }
  public ErrorCode setControlFramePeriod (ControlFrame frame, int periodMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setControlFramePeriod(" + String.valueOf(frame) + ", " + String.valueOf(periodMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode setStatusFramePeriod (int frameValue, int periodMs, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setStatusFramePeriod(" + String.valueOf(frameValue) + ", " + String.valueOf(periodMs) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode setStatusFramePeriod (int frameValue, int periodMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setStatusFramePeriod(" + String.valueOf(frameValue) + ", " + String.valueOf(periodMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configForwardLimitSwitchSource (RemoteLimitSwitchSource type, LimitSwitchNormal normalOpenOrClose, int deviceID, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configForwardLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ", " + String.valueOf(deviceID) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configForwardLimitSwitchSource (RemoteLimitSwitchSource type, LimitSwitchNormal normalOpenOrClose, int deviceID) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configForwardLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ", " + String.valueOf(deviceID) + ")");
      return null;
    }
  }
  public ErrorCode configReverseLimitSwitchSource (RemoteLimitSwitchSource type, LimitSwitchNormal normalOpenOrClose, int deviceID, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configReverseLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ", " + String.valueOf(deviceID) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configReverseLimitSwitchSource (RemoteLimitSwitchSource type, LimitSwitchNormal normalOpenOrClose, int deviceID) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configReverseLimitSwitchSource(" + String.valueOf(type) + ", " + String.valueOf(normalOpenOrClose) + ", " + String.valueOf(deviceID) + ")");
      return null;
    }
  }
  public void overrideLimitSwitchesEnable (boolean enable) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("overrideLimitSwitchesEnable(" + String.valueOf(enable) + ")");
    }
  }
  public ErrorCode configForwardSoftLimitThreshold (int forwardSensorLimit, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configForwardSoftLimitThreshold(" + String.valueOf(forwardSensorLimit) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configForwardSoftLimitThreshold (int forwardSensorLimit) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configForwardSoftLimitThreshold(" + String.valueOf(forwardSensorLimit) + ")");
      return null;
    }
  }
  public ErrorCode configReverseSoftLimitThreshold (int reverseSensorLimit, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configReverseSoftLimitThreshold(" + String.valueOf(reverseSensorLimit) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configReverseSoftLimitThreshold (int reverseSensorLimit) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configReverseSoftLimitThreshold(" + String.valueOf(reverseSensorLimit) + ")");
      return null;
    }
  }
  public ErrorCode configForwardSoftLimitEnable (boolean enable, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configForwardSoftLimitEnable(" + String.valueOf(enable) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configForwardSoftLimitEnable (boolean enable) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configForwardSoftLimitEnable(" + String.valueOf(enable) + ")");
      return null;
    }
  }
  public ErrorCode configReverseSoftLimitEnable (boolean enable, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configReverseSoftLimitEnable(" + String.valueOf(enable) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configReverseSoftLimitEnable (boolean enable) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configReverseSoftLimitEnable(" + String.valueOf(enable) + ")");
      return null;
    }
  }
  public void overrideSoftLimitsEnable (boolean enable) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("overrideSoftLimitsEnable(" + String.valueOf(enable) + ")");
    }
  }
  public ErrorCode config_kP (int slotIdx, double value, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("config_kP(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode config_kP (int slotIdx, double value) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("config_kP(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ")");
      return null;
    }
  }
  public ErrorCode config_kI (int slotIdx, double value, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("config_kI(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode config_kI (int slotIdx, double value) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("config_kI(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ")");
      return null;
    }
  }
  public ErrorCode config_kD (int slotIdx, double value, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("config_kD(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode config_kD (int slotIdx, double value) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("config_kD(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ")");
      return null;
    }
  }
  public ErrorCode config_kF (int slotIdx, double value, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("config_kF(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode config_kF (int slotIdx, double value) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("config_kF(" + String.valueOf(slotIdx) + ", " + String.valueOf(value) + ")");
      return null;
    }
  }
  public ErrorCode config_IntegralZone (int slotIdx, int izone, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("config_IntegralZone(" + String.valueOf(slotIdx) + ", " + String.valueOf(izone) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode config_IntegralZone (int slotIdx, int izone) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("config_IntegralZone(" + String.valueOf(slotIdx) + ", " + String.valueOf(izone) + ")");
      return null;
    }
  }
  public ErrorCode configAllowableClosedloopError (int slotIdx, int allowableClosedLoopError, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configAllowableClosedloopError(" + String.valueOf(slotIdx) + ", " + String.valueOf(allowableClosedLoopError) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configAllowableClosedloopError (int slotIdx, int allowableClosedLoopError) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configAllowableClosedloopError(" + String.valueOf(slotIdx) + ", " + String.valueOf(allowableClosedLoopError) + ")");
      return null;
    }
  }
  public ErrorCode configMaxIntegralAccumulator (int slotIdx, double iaccum, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configMaxIntegralAccumulator(" + String.valueOf(slotIdx) + ", " + String.valueOf(iaccum) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configMaxIntegralAccumulator (int slotIdx, double iaccum) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configMaxIntegralAccumulator(" + String.valueOf(slotIdx) + ", " + String.valueOf(iaccum) + ")");
      return null;
    }
  }
  public ErrorCode configClosedLoopPeakOutput (int slotIdx, double percentOut, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configClosedLoopPeakOutput(" + String.valueOf(slotIdx) + ", " + String.valueOf(percentOut) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configClosedLoopPeakOutput (int slotIdx, double percentOut) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configClosedLoopPeakOutput(" + String.valueOf(slotIdx) + ", " + String.valueOf(percentOut) + ")");
      return null;
    }
  }
  public ErrorCode configClosedLoopPeriod (int slotIdx, int loopTimeMs, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configClosedLoopPeriod(" + String.valueOf(slotIdx) + ", " + String.valueOf(loopTimeMs) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configClosedLoopPeriod (int slotIdx, int loopTimeMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configClosedLoopPeriod(" + String.valueOf(slotIdx) + ", " + String.valueOf(loopTimeMs) + ")");
      return null;
    }
  }
  public ErrorCode configAuxPIDPolarity (boolean invert, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configAuxPIDPolarity(" + String.valueOf(invert) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configAuxPIDPolarity (boolean invert) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configAuxPIDPolarity(" + String.valueOf(invert) + ")");
      return null;
    }
  }
  public ErrorCode setIntegralAccumulator (double iaccum, int pidIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setIntegralAccumulator(" + String.valueOf(iaccum) + ", " + String.valueOf(pidIdx) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode setIntegralAccumulator (double iaccum) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("setIntegralAccumulator(" + String.valueOf(iaccum) + ")");
      return null;
    }
  }
  public int getClosedLoopError (int pidIdx) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getClosedLoopError(" + String.valueOf(pidIdx) + ")");
      return 0;
    }
  }
  public int getClosedLoopError () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getClosedLoopError()");
      return 0;
    }
  }
  public double getIntegralAccumulator (int pidIdx) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getIntegralAccumulator(" + String.valueOf(pidIdx) + ")");
      return 0;
    }
  }
  public double getIntegralAccumulator () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getIntegralAccumulator()");
      return 0;
    }
  }
  public double getErrorDerivative (int pidIdx) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getErrorDerivative(" + String.valueOf(pidIdx) + ")");
      return 0;
    }
  }
  public double getErrorDerivative () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getErrorDerivative()");
      return 0;
    }
  }
  public void selectProfileSlot (int slotIdx, int pidIdx) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("selectProfileSlot(" + String.valueOf(slotIdx) + ", " + String.valueOf(pidIdx) + ")");
    }
  }
  public double getClosedLoopTarget (int pidIdx) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getClosedLoopTarget(" + String.valueOf(pidIdx) + ")");
      return 0;
    }
  }
  public double getClosedLoopTarget () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getClosedLoopTarget()");
      return 0;
    }
  }
  public int getActiveTrajectoryPosition () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getActiveTrajectoryPosition()");
      return 0;
    }
  }
  public int getActiveTrajectoryPosition (int pidIdx) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getActiveTrajectoryPosition(" + String.valueOf(pidIdx) + ")");
      return 0;
    }
  }
  public int getActiveTrajectoryVelocity () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getActiveTrajectoryVelocity()");
      return 0;
    }
  }
  public int getActiveTrajectoryVelocity (int pidIdx) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getActiveTrajectoryVelocity(" + String.valueOf(pidIdx) + ")");
      return 0;
    }
  }
  public double getActiveTrajectoryHeading () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getActiveTrajectoryHeading()");
      return 0;
    }
  }
  public double getActiveTrajectoryArbFeedFwd () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getActiveTrajectoryArbFeedFwd()");
      return 0;
    }
  }
  public double getActiveTrajectoryArbFeedFwd (int pidIdx) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getActiveTrajectoryArbFeedFwd(" + String.valueOf(pidIdx) + ")");
      return 0;
    }
  }
  public ErrorCode configMotionCruiseVelocity (int sensorUnitsPer100ms, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configMotionCruiseVelocity(" + String.valueOf(sensorUnitsPer100ms) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configMotionCruiseVelocity (int sensorUnitsPer100ms) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configMotionCruiseVelocity(" + String.valueOf(sensorUnitsPer100ms) + ")");
      return null;
    }
  }
  public ErrorCode configMotionAcceleration (int sensorUnitsPer100msPerSec, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configMotionAcceleration(" + String.valueOf(sensorUnitsPer100msPerSec) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configMotionAcceleration (int sensorUnitsPer100msPerSec) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configMotionAcceleration(" + String.valueOf(sensorUnitsPer100msPerSec) + ")");
      return null;
    }
  }
  public ErrorCode configMotionSCurveStrength (int curveStrength, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configMotionSCurveStrength(" + String.valueOf(curveStrength) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configMotionSCurveStrength (int curveStrength) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configMotionSCurveStrength(" + String.valueOf(curveStrength) + ")");
      return null;
    }
  }
  public ErrorCode clearMotionProfileTrajectories () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("clearMotionProfileTrajectories()");
      return null;
    }
  }
  public int getMotionProfileTopLevelBufferCount () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getMotionProfileTopLevelBufferCount()");
      return 0;
    }
  }
  public ErrorCode pushMotionProfileTrajectory (TrajectoryPoint trajPt) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("pushMotionProfileTrajectory(" + String.valueOf(trajPt) + ")");
      return null;
    }
  }
  public ErrorCode startMotionProfile (BufferedTrajectoryPointStream stream, int minBufferedPts, ControlMode motionProfControlMode) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("startMotionProfile(" + String.valueOf(stream) + ", " + String.valueOf(minBufferedPts) + ", " + String.valueOf(motionProfControlMode) + ")");
      return null;
    }
  }
  public boolean isMotionProfileFinished () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("isMotionProfileFinished()");
      return false;
    }
  }
  public boolean isMotionProfileTopLevelBufferFull () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("isMotionProfileTopLevelBufferFull()");
      return false;
    }
  }
  public void processMotionProfileBuffer () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("processMotionProfileBuffer()");
    }
  }
  public ErrorCode getMotionProfileStatus (MotionProfileStatus statusToFill) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getMotionProfileStatus(" + String.valueOf(statusToFill) + ")");
      return null;
    }
  }
  public ErrorCode clearMotionProfileHasUnderrun (int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("clearMotionProfileHasUnderrun(" + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode clearMotionProfileHasUnderrun () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("clearMotionProfileHasUnderrun()");
      return null;
    }
  }
  public ErrorCode changeMotionControlFramePeriod (int periodMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("changeMotionControlFramePeriod(" + String.valueOf(periodMs) + ")");
      return null;
    }
  }
  public ErrorCode configMotionProfileTrajectoryPeriod (int baseTrajDurationMs, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configMotionProfileTrajectoryPeriod(" + String.valueOf(baseTrajDurationMs) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configMotionProfileTrajectoryPeriod (int baseTrajDurationMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configMotionProfileTrajectoryPeriod(" + String.valueOf(baseTrajDurationMs) + ")");
      return null;
    }
  }
  public ErrorCode configMotionProfileTrajectoryInterpolationEnable (boolean enable, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configMotionProfileTrajectoryInterpolationEnable(" + String.valueOf(enable) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configMotionProfileTrajectoryInterpolationEnable (boolean enable) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configMotionProfileTrajectoryInterpolationEnable(" + String.valueOf(enable) + ")");
      return null;
    }
  }
  public ErrorCode configFeedbackNotContinuous (boolean feedbackNotContinuous, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configFeedbackNotContinuous(" + String.valueOf(feedbackNotContinuous) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configRemoteSensorClosedLoopDisableNeutralOnLOS (boolean remoteSensorClosedLoopDisableNeutralOnLOS, int timeoutMs) {
    if(Robot.isReal()){
      return thisTalon.configRemoteSensorClosedLoopDisableNeutralOnLOS(remoteSensorClosedLoopDisableNeutralOnLOS, timeoutMs);
    }else{
      mLogger.verbose("configRemoteSensorClosedLoopDisableNeutralOnLOS(" + String.valueOf(remoteSensorClosedLoopDisableNeutralOnLOS) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configClearPositionOnLimitF (boolean clearPositionOnLimitF, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configClearPositionOnLimitF(" + String.valueOf(clearPositionOnLimitF) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configClearPositionOnLimitR (boolean clearPositionOnLimitR, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configClearPositionOnLimitR(" + String.valueOf(clearPositionOnLimitR) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configClearPositionOnQuadIdx (boolean clearPositionOnQuadIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configClearPositionOnQuadIdx(" + String.valueOf(clearPositionOnQuadIdx) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configLimitSwitchDisableNeutralOnLOS (boolean limitSwitchDisableNeutralOnLOS, int timeoutMs) {
    if(Robot.isReal()){
      return thisTalon.configLimitSwitchDisableNeutralOnLOS(limitSwitchDisableNeutralOnLOS, timeoutMs);
    }else{
      mLogger.verbose("configLimitSwitchDisableNeutralOnLOS(" + String.valueOf(limitSwitchDisableNeutralOnLOS) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configSoftLimitDisableNeutralOnLOS (boolean softLimitDisableNeutralOnLOS, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configSoftLimitDisableNeutralOnLOS(" + String.valueOf(softLimitDisableNeutralOnLOS) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configPulseWidthPeriod_EdgesPerRot (int pulseWidthPeriod_EdgesPerRot, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configPulseWidthPeriod_EdgesPerRot(" + String.valueOf(pulseWidthPeriod_EdgesPerRot) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configPulseWidthPeriod_FilterWindowSz (int pulseWidthPeriod_FilterWindowSz, int timeoutMs) {
    if(Robot.isReal()){
      return thisTalon.configPulseWidthPeriod_FilterWindowSz(pulseWidthPeriod_FilterWindowSz, timeoutMs);
    }else{
      mLogger.verbose("configPulseWidthPeriod_FilterWindowSz(" + String.valueOf(pulseWidthPeriod_FilterWindowSz) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode getFaults (Faults toFill) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getFaults(" + String.valueOf(toFill) + ")");
      return null;
    }
  }
  public ErrorCode getStickyFaults (StickyFaults toFill) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getStickyFaults(" + String.valueOf(toFill) + ")");
      return null;
    }
  }
  public ErrorCode clearStickyFaults (int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("clearStickyFaults(" + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode clearStickyFaults () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("clearStickyFaults()");
      return null;
    }
  }
  public int getFirmwareVersion () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getFirmwareVersion()");
      return 0;
    }
  }
  public boolean hasResetOccurred () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("hasResetOccurred()");
      return false;
    }
  }
  public ErrorCode configSetCustomParam (int newValue, int paramIndex, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configSetCustomParam(" + String.valueOf(newValue) + ", " + String.valueOf(paramIndex) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configSetCustomParam (int newValue, int paramIndex) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configSetCustomParam(" + String.valueOf(newValue) + ", " + String.valueOf(paramIndex) + ")");
      return null;
    }
  }
  public int configGetCustomParam (int paramIndex, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configGetCustomParam(" + String.valueOf(paramIndex) + ", " + String.valueOf(timeoutMs) + ")");
      return 0;
    }
  }
  public int configGetCustomParam (int paramIndex) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configGetCustomParam(" + String.valueOf(paramIndex) + ")");
      return 0;
    }
  }
  public ErrorCode configSetParameter (ParamEnum param, double value, int subValue, int ordinal, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configSetParameter(" + String.valueOf(param) + ", " + String.valueOf(value) + ", " + String.valueOf(subValue) + ", " + String.valueOf(ordinal) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configSetParameter (ParamEnum param, double value, int subValue, int ordinal) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configSetParameter(" + String.valueOf(param) + ", " + String.valueOf(value) + ", " + String.valueOf(subValue) + ", " + String.valueOf(ordinal) + ")");
      return null;
    }
  }
  ...
  public double configGetParameter (ParamEnum param, int ordinal, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configGetParameter(" + String.valueOf(param) + ", " + String.valueOf(ordinal) + ", " + String.valueOf(timeoutMs) + ")");
      return 0;
    }
  }
  public double configGetParameter (ParamEnum param, int ordinal) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configGetParameter(" + String.valueOf(param) + ", " + String.valueOf(ordinal) + ")");
      return 0;
    }
  }
  ...
  public ControlMode getControlMode () {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getControlMode()");
      return null;
    }
  }
  public void follow (IMotorController masterToFollow, FollowerType followerType) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("follow(" + String.valueOf(masterToFollow) + ", " + String.valueOf(followerType) + ")");
    }
  }
  public void follow (IMotorController masterToFollow) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("follow(" + String.valueOf(masterToFollow) + ")");
    }
  }
  ...
  public ErrorCode configureSlot (SlotConfiguration slot) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configureSlot(" + String.valueOf(slot) + ")");
      return null;
    }
  }
  public ErrorCode configureSlot (SlotConfiguration slot, int slotIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configureSlot(" + String.valueOf(slot) + ", " + String.valueOf(slotIdx) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public void getSlotConfigs (SlotConfiguration slot, int slotIdx, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getSlotConfigs(" + String.valueOf(slot) + ", " + String.valueOf(slotIdx) + ", " + String.valueOf(timeoutMs) + ")");
    }
  }
  public void getSlotConfigs (SlotConfiguration slot) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getSlotConfigs(" + String.valueOf(slot) + ")");
    }
  }
  public ErrorCode configureFilter (FilterConfiguration filter, int ordinal, int timeoutMs, boolean enableOptimizations) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configureFilter(" + String.valueOf(filter) + ", " + String.valueOf(ordinal) + ", " + String.valueOf(timeoutMs) + ", " + String.valueOf(enableOptimizations) + ")");
      return null;
    }
  }
  public ErrorCode configureFilter (FilterConfiguration filter, int ordinal, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configureFilter(" + String.valueOf(filter) + ", " + String.valueOf(ordinal) + ", " + String.valueOf(timeoutMs) + ")");
      return null;
    }
  }
  public ErrorCode configureFilter (FilterConfiguration filter) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("configureFilter(" + String.valueOf(filter) + ")");
      return null;
    }
  }
  public void getFilterConfigs (FilterConfiguration filter, int ordinal, int timeoutMs) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getFilterConfigs(" + String.valueOf(filter) + ", " + String.valueOf(ordinal) + ", " + String.valueOf(timeoutMs) + ")");
    }
  }
  public void getFilterConfigs (FilterConfiguration filter) {
    if(Robot.isReal()){
      ...
      mLogger.verbose("getFilterConfigs(" + String.valueOf(filter) + ")");
    }
  }
}