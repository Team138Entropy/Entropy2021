...
public class OurWPITalonSRX {
  ...
  public final void setName(String moduleType, int channel) {
    if (Robot.isReal()) {
      ...
      mLogger.verbose(
          "setName(" + String.valueOf(moduleType) + ", " + String.valueOf(channel) + ")");
    }
  }
  ...
  public void getAllConfigs(TalonSRXConfiguration allConfigs, int timeoutMs) {
    if (Robot.isReal()) {
      ...
      mLogger.verbose(
          "getAllConfigs(" + String.valueOf(allConfigs) + ", " + String.valueOf(timeoutMs) + ")");
    }
  }
  ...
  public ErrorCode setStatusFramePeriod(StatusFrameEnhanced frame, int periodMs) {
    if (Robot.isReal()) {
      ...
      mLogger.verbose(
          "setStatusFramePeriod(" + String.valueOf(frame) + ", " + String.valueOf(periodMs) + ")");
      return null;
    }
  }
  ...
  public int getStatusFramePeriod(StatusFrameEnhanced frame, int timeoutMs) {
    if (Robot.isReal()) {
      ...
      mLogger.verbose(
          "getStatusFramePeriod(" + String.valueOf(frame) + ", " + String.valueOf(timeoutMs) + ")");
      return 0;
    }
  }
  ...
  public ErrorCode configVoltageMeasurementFilter(int filterWindowSamples) {
    if (Robot.isReal()) {
      ...
      mLogger.verbose(
          "configVoltageMeasurementFilter(" + String.valueOf(filterWindowSamples) + ")");
      return null;
    }
  }
  ...
  public ErrorCode setControlFramePeriod(ControlFrame frame, int periodMs) {
    if (Robot.isReal()) {
      ...
      mLogger.verbose(
          "setControlFramePeriod(" + String.valueOf(frame) + ", " + String.valueOf(periodMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configForwardSoftLimitThreshold(int forwardSensorLimit) {
    if (Robot.isReal()) {
      ...
      mLogger.verbose(
          "configForwardSoftLimitThreshold(" + String.valueOf(forwardSensorLimit) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configReverseSoftLimitThreshold(int reverseSensorLimit) {
    if (Robot.isReal()) {
      ...
      mLogger.verbose(
          "configReverseSoftLimitThreshold(" + String.valueOf(reverseSensorLimit) + ")");
      return null;
    }
  }
  ...
  public ErrorCode config_IntegralZone(int slotIdx, int izone) {
    if (Robot.isReal()) {
      ...
      mLogger.verbose(
          "config_IntegralZone(" + String.valueOf(slotIdx) + ", " + String.valueOf(izone) + ")");
      return null;
    }
  }
  ...
  public void selectProfileSlot(int slotIdx, int pidIdx) {
    if (Robot.isReal()) {
      ...
      mLogger.verbose(
          "selectProfileSlot(" + String.valueOf(slotIdx) + ", " + String.valueOf(pidIdx) + ")");
    }
  }
  ...
  public ErrorCode configMotionAcceleration(int sensorUnitsPer100msPerSec) {
    if (Robot.isReal()) {
      ...
      mLogger.verbose(
          "configMotionAcceleration(" + String.valueOf(sensorUnitsPer100msPerSec) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configMotionProfileTrajectoryPeriod(int baseTrajDurationMs) {
    if (Robot.isReal()) {
      ...
      mLogger.verbose(
          "configMotionProfileTrajectoryPeriod(" + String.valueOf(baseTrajDurationMs) + ")");
      return null;
    }
  }
  ...
  public ErrorCode configMotionProfileTrajectoryInterpolationEnable(boolean enable) {
    if (Robot.isReal()) {
      ...
      mLogger.verbose(
          "configMotionProfileTrajectoryInterpolationEnable(" + String.valueOf(enable) + ")");
      return null;
    }
  }
  ...
  public double configGetParameter(ParamEnum param, int ordinal) {
    if (Robot.isReal()) {
      ...
      mLogger.verbose(
          "configGetParameter(" + String.valueOf(param) + ", " + String.valueOf(ordinal) + ")");
      return 0;
    }
  }
  ...
  public void follow(IMotorController masterToFollow, FollowerType followerType) {
    if (Robot.isReal()) {
      ...
      mLogger.verbose(
          "follow(" + String.valueOf(masterToFollow) + ", " + String.valueOf(followerType) + ")");
    }
  }
