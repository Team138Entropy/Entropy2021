...
public class Config {
  ...
  public enum Key {
    ...
    STORAGE__ROLLER_STORE_SPEED(.5d),
    STORAGE__ROLLER_SPEED_FACTOR(0.5d),
    STORAGE__ROLLER_BOTTOM_SPEED_FACTOR(1.15d),
    STORAGE__ROLLER_EJECT_SPEED(.4d),
    ...
    CLIMBER__EXTENDED_HEIGHT_IN_ENCODER_TICKS(65000),
    CLIMBER__RETRACTED_HEIGHT_IN_ENCODER_TICKS(3000),
    STORAGE__BALL_DISTANCE_IN_ENCODER_TICKS_PRACTICE(250d),
    STORAGE__BALL_DISTANCE_IN_ENCODER_TICKS_PRODUCTION(300d),
